 ...
 */
public class MyCustomMqttClient implements MqttCallback {
   ...
   * @param password the password for the user
	 ...
	 */
    public MyCustomMqttClient(String brokerUrl, String clientId, boolean cleanSession, boolean quietMode, String userName, String password) throws MqttException {
